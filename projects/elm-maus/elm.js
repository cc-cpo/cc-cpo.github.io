...
var $author$project$Main$ShowHeart = {$: 'ShowHeart'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Confetti$Burst = {$: 'Burst'};
...
var $author$project$Confetti$init = _Utils_Tuple2(
	{
		mouse: _Utils_Tuple2(20, 200),
	...
	$elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
				...
				$elm$core$Task$perform,
				function (_v0) {
					return $author$project$Confetti$Burst;
				},
				...
				$elm$core$Process$sleep(2900)),
				A2(
				$elm$core$Task$perform,
				function (_v2) {
					return $author$project$Confetti$Burst;
				},
				$elm$core$Process$sleep(3700)),
				A2(
				$elm$core$Task$perform,
				function (_v3) {
					return $author$project$Confetti$Burst;
				},
				$elm$core$Process$sleep(4250)),
				A2(
				$elm$core$Task$perform,
				function (_v4) {
					return $author$project$Confetti$Burst;
				},
				$elm$core$Process$sleep(7000))
			])));
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$init = function (_v0) {
	var _v1 = $author$project$Confetti$init;
	...
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Platform$Cmd$map, $author$project$Main$ParticleMsg, initConfettiCmd),
					A2(
					$elm$core$Task$perform,
					function (_v2) {
						return $author$project$Main$ShowHeart;
					},
					$elm$core$Process$sleep(6000))
				])));
};
...
var $author$project$Confetti$subscriptions = function (model) {
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onAnimationFrame($author$project$Main$Animate),
				A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$ParticleMsg,
						...
						model,
						{
							system: A2(
								...
								A2(
									...
									25,
									A2($author$project$Confetti$particleAt, x + 50, y - 20)),
								model.system)
						}),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ParticleMsg':
				var confettiMsg = msg.a;
				var _v1 = A2($author$project$Confetti$update, confettiMsg, model.confettiModel);
				var newModel = _v1.a;
				var newCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{confettiModel: newModel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$ParticleMsg, newCmd));
			case 'Animate':
				var time = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$heart = function (fadeIn) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$class('heart'),
...
var $author$project$Main$photoFrame = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('photo'),
			$elm$html$Html$Attributes$class('sample6')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$src('images/bolzano170x120.jpg')
						]),
					_List_Nil)
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src('images/tada.png'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', '#b1e8ed')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
						A2($elm$html$Html$Attributes$style, 'left', '70px'),
						A2($elm$html$Html$Attributes$style, 'top', '180px')
					]),
				_List_fromArray(
					[$author$project$Main$photoFrame]))
			]));
};
